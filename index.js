...
let Jennifer = ["id: 21",
  ...
  "genre: Web Design", 
  "nationality: Irish",
  "bio: Lorem ipsum dolor sit amet, ut quando euripidis philosophia usu. Enim solum definitiones usu te, te vim mundi populo eripuit. Ea sed elit adipiscing, dicant." ];
function addArtist(Jennifer){
